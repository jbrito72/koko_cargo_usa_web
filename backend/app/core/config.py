...
class Settings(BaseSettings):
    ...
    # SMTP configuration removed - not using email authentication
    
    # First superuser configuration (using nombres instead of email)
    FIRST_SUPERUSER: str = "admin"  # Username instead of email
